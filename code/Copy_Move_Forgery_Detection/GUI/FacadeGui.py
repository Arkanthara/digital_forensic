...
class Facade(metaclass=SingletonMeta):
    ...
    def setupUi(self, main_window):
        ...
        self.label.setStyleSheet(
            "QLabel{ background-color : rgb(204, 231, 232); color : black; }"
        )
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("icons/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("icons/surf.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap("icons/akaze.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap("icons/sift.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap("icons/zoom_in.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(
            QtGui.QPixmap("icons/zoom_out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
    ...
    def translateUi(self, main_window):
        ...
        self.action_Undo.setToolTip(
            _translate("MainWindow", "Yapılan İşlemleri Geri Al")
        )
    ...
    def saveImage(self):
        ...
        if root.filename:
            try:
                save_img = Image.fromarray(self.image.astype("uint8"))
    ...
    def showImage(self, img_show):
        ...
        )  # görüntüyü ölçeklendirmek ve En Boy Oranını korumak için
